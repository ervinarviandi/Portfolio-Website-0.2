  ...
  return (
    <div className='w-full py-10'>
        <div className='md:max-w-7xl mx-auto lg:px-10 px-5 '>
            ...
            <div className='grid md:grid-cols-2 gap-5  max-w-4xl  mx-auto mt-4'>
                <div className='flex flex-col'>
                    <div className='dark:bg-[#1e1e1e] bg-[#fff] rounded-lg  border-slate-200 dark:border-none border-2 hover:shadow-md hover:scale-[102%] duration-300 ease-in-out relative group '>
                        ...
                        <Image src={Projects1} width={500} height={500} alt='QrCode'   
                ...
                <div className='flex flex-col'>
                    <div className='dark:bg-[#1e1e1e] bg-[#fff] rounded-lg  border-slate-200 dark:border-none border-2 hover:shadow-md hover:scale-[102%] duration-300 ease-in-out relative group '>
                        ...
                        <Image src={Logo} width={500} height={500} alt='starterKit' 
                        className="rounded-t-lg"
                      /> 
                        <div className='absolute inset-0 translate-y-[100%] group-hover:translate-y-0 px-4 bg-gradient-to-b from-[#000000]/60 via-[#000000]/90 to-[#000000]/90 py-7 transition-all duration-300  rounded-t-lg '>
                            <Link href="/starterTemplate" className='flex justify-center items-center gap-2 py-[50px] group 0 hover:text-[#05b6d3]  text-gray-200 '>View Project
                            <FaArrowRight/>
                            </Link>
                        ...
                        <div className='p-4'>
                            <h2 className='md:text-xl text-lg font-bold group-hover:text-transparent bg-clip-text bg-gradient-to-r from-[#22d3ee] via-[#d9f99d] to-[#bef264]    '>Next App Router Starter Kit</h2>
                            <p className='md:text-md text-sm dark:text-dark-100 text-white-100 py-3'>Next js 14.0.2 starter kit using Tailwind CSS, Zustand, SWR, Lint and Formatter.</p>
                            <div className='flex items-center gap-2'>
                                <NextLogo />
                                <TypescriptLogo/>
                                <TailwindLogo/>
            ...
            <Link href="/portfolio" className=' item-center gap-2 flex text-sm dark:text-dark-100'>
          View All Projects
