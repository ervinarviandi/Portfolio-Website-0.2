...
function Cursor() {
  ...
  return (
    <div
      id="cursor"
      className="dark:before:bg-white pointer-events-none fixed left-0 top-0 z-50 hidden before:absolute before:-left-6 before:-top-6 before:block before:h-12 before:w-12 before:scale-[0.2] before:rounded-full before:bg-black md:block"
