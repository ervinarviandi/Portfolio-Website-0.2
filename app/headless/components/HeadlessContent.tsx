...
const HeadlessContent = () => {
  return (
    <div>
        ...
        <p className='mt-4'>1. Buka terminal atau command prompt. disini saya merekomendasikan teman-teman menggunakan git, kalian bisa mendownloadnya <Link href="https://git-scm.com/" className='text-[#05b6d3]'>disini</Link> </p>
        ...
        <p className='mt-3'>4. Setelah instalasi selesai, teman-teman dapat mengimpor komponen Headless UI yang diperlukan ke dalam file React teman-teman dan mulai menggunakannya.</p>
        ...
        <p className='mt-3'>Semoga membantu ya! 👋🧐 </p>
          </div>
    </div>
  )
}
