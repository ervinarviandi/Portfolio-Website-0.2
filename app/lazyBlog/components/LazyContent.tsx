    ...
    <div>
        ...
        Image  <br />Dengan Efek Blur</h1>
          ...
          <div className='mt-7'>
            ...
            <p className='text-md'>Gambar adalah komponen terberat dari sebuah situs web. Gambar mencegah situs web memuat lebih cepat dan menurunkan kinerjanya. Hal ini mungkin mengakibatkan pengalaman pengguna yang buruk. Oleh karena itu, dalam artikel ini, saya akan mengajari teman-teman cara paling sederhana dan termudah untuk menambahkan gambar buram saat memuat halaman di dalam project React js.</p>

            <p className='mt-5 text-md'>Pada artikel ini, saya akan menggunakan Tailwind CSS. Pengetahuan dasar tentang Tailwind CSS akan diperlukan.</p>
            <p className='text-md mt-5'>Langkah 1: Install Tailwind CSS with Next.js</p>
            <p className='text-md mt-5'>Inisialisasi tailwind di dalam aplikasi Next.js</p>
          </div>
          <div className='bg-[#282a36] p-2 mt-5 rounded-lg md:w-8/12'>
            <p className='text-md'>  <span className='text-blue-400'>npm</span> install -D tailwindcss postcss autoprefixer</p>
            <p className='mt-2 text-md'> <span className='text-blue-400'>npx</span> tailwindcss init -p</p>
          </div>
          <p className='mt-5'>untuk lebih jelasnya kalian bisa baca dokumentasi di website resminya <Link href="https://tailwindcss.com/" className='text-[#38bdf8]'>https://tailwindcss.com/</Link></p>

          <p className='mt-5 text-md'>Langkah 2: Buat Component Gambar Blur</p>
          <p className='mt-5 text-md'>Buat file baru dengan nama <span className='p-2 rounded-lg bg-[#282a36]'>BlurImage.jsx</span> di dalam folder component</p>
          <p className='text-md mt-5'>Di dalam folder komponen/BlurImage.jsx, tambahkan kode berikut,</p>
          ...
          <Image src={Code2} width={500} height={500} alt='Code2'/>
            ...
            <p className='mt-5 text-md'>Ini akan membuat gambar menjadi blur saat memuat halaman hingga gambar dimuat sepenuhnya.</p>
            <p className='mt-5'>terimakasih Sudah Membaca ! 🚀😉</p>
