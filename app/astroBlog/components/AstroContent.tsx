    ...
    <div>
        ...
        simple <br /> ngebut pakai Astro</h1>
          ...
          <ol typeof='A' className='text-md '>
            ...
            <li className='mt-2 md:text-base text-sm'>2. Bikin project baru pake Astro, jalanin command ini: <span className='p-2 bg-gray-600 rounded-md md:text-md text-xs text-[#fff]'>npm create astro@latest</span></li>
            ...
            <li className='mt-2 md:text-base text-sm'>4. Kalo udah selesai, kamu bakal disuruh buat jalanin cd ke-directory yang kamu buat trus jalanin <span className='md:text-md text-xs bg-gray-600 p-2 rounded-md text-[#fff]'>npm run dev</span></li>
            ...
            <li className='mt-2 md:text-base text-sm'>6. Buat ngerjain segala project, sekarang aku pake tailwindcss buat mempermudah proses styling webnya, pake Astro gampang banget (matiin dulu <span className='md:text-md text-xs bg-gray-600 p-2 rounded-md text-[#fff]'>npm run dev</span>  yg tadi udah dijalanin) trus tinggal run: <span className='md:text-md text-xs bg-gray-600 p-2 rounded-md text-[#fff]'>npx astro add tailwind</span>  trus ikutin prosesnya (yes-yes aja), then done. Bisa jalanin development mode nya lagi (<span className='md:text-md text-xs bg-gray-600 p-2 rounded-md text-[#fff]'>npm run dev</span> )</li>
