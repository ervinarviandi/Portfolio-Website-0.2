  ...
  return (
    ...
    <div className='w-full pt-20' data-aos="fade-up">
        <div className='md:max-w-7xl mx-auto lg:px-10 px-5'>
            ...
            <p className='mt-4 md:text-lg dark:text-dark-100 text-white-100 text-sm'>This is a collection of several certificates that I have received while participating in events & webinars.</p>
